...
| <img src='img/white/knight.svg' width='40' valign='middle'> | **Knight** | `G6` | [E5](https://github.com/madhavagarwal3012/madhavagarwal3012/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G6+to+E5), [E7](https://github.com/madhavagarwal3012/madhavagarwal3012/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G6+to+E7), [F8](https://github.com/madhavagarwal3012/madhavagarwal3012/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G6+to+F8), [H4](https://github.com/madhavagarwal3012/madhavagarwal3012/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G6+to+H4), [H8](https://github.com/madhavagarwal3012/madhavagarwal3012/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+G6+to+H8) |
...
| Move | Author |
| :--: | :----- |
| `H8` to `H7` | [ @madhavagarwal3012](https://github.com/madhavagarwal3012) |
| `F8` to `G6` | [ @madhavagarwal3012](https://github.com/madhavagarwal3012) |
| `E3` to `E2` | [ @madhavagarwal3012](https://github.com/madhavagarwal3012) |
| `E6` to `F8` | [ @madhavagarwal3012](https://github.com/madhavagarwal3012) |
...
| Total moves |  User  |
| :---------: | :----- |
| 76 | [@madhavagarwal3012](https://github.com/madhavagarwal3012) |
